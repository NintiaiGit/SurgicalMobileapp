...
public class ChannelPushSettingActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, ChannelPushSettingActivity.class, channelUrl, themeResId);
    }
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends ChannelPushSettingActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
