...
public class MutedMemberListActivity extends AppCompatActivity {
     ...
     * @return MutedMemberListActivity Intent.
     * since 3.5.6
     */
    @NonNull
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, MutedMemberListActivity.class, channelUrl, themeResId);
    }
    ...
    /**
     * Create an intent for a custom activity. The custom activity must inherit {@link MutedMemberListActivity}.
     *
     * @param context    A Context of the application package implementing this class.
     * @param cls        The activity class that is to be used for the intent.
     * @param channelUrl the url of the channel will be implemented.
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends MutedMemberListActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
