...
public class ChannelSettingsActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, ChannelSettingsActivity.class, channelUrl, themeResId);
    }
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends ChannelSettingsActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
    ...
    /**
     * It will be called when the {@link ChannelSettingsActivity} is being created.
