...
public class OpenChannelSettingsActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, OpenChannelSettingsActivity.class, channelUrl, themeResId);
    }
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends OpenChannelSettingsActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
    ...
    /**
     * It will be called when the {@link OpenChannelSettingsActivity} is being created.
    ...
    protected Fragment createFragment() {
        ...
        return SendbirdUIKit.getFragmentFactory().newOpenChannelSettingsFragment(args.getString(StringSet.KEY_CHANNEL_URL, ""), args);
    }
}
