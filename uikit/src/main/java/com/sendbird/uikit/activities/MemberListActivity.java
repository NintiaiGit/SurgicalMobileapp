...
public class MemberListActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, MemberListActivity.class, channelUrl, themeResId);
    }
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends MemberListActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
