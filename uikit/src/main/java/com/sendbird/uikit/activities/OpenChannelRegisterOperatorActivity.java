...
public class OpenChannelRegisterOperatorActivity extends AppCompatActivity {
    ...
    /**
     * Create an intent for a {@link OpenChannelRegisterOperatorActivity}.
     *
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl) {
        return newIntentFromCustomActivity(context, OpenChannelRegisterOperatorActivity.class, channelUrl);
    }
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, OpenChannelRegisterOperatorActivity.class, channelUrl, themeResId);
    }


    /**
     * Create an intent for a custom activity. The custom activity must inherit {@link OpenChannelRegisterOperatorActivity}.
     *
     * @param context    A Context of the application package implementing this class.
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends OpenChannelRegisterOperatorActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
    ...
    /**
     * It will be called when the {@link OpenChannelRegisterOperatorActivity} is being created.
    ...
    protected Fragment createFragment() {
        ...
        return SendbirdUIKit.getFragmentFactory().newOpenChannelRegisterOperatorFragment(args.getString(StringSet.KEY_CHANNEL_URL, ""), args);
    }
}
