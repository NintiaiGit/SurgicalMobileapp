...
public class ModerationActivity extends AppCompatActivity {
    ...
    public static Intent newIntent(@NonNull Context context, @NonNull String channelUrl, @StyleRes int themeResId) {
        return newIntentFromCustomActivity(context, ModerationActivity.class, channelUrl, themeResId);
    }
     ...
     */
    @NonNull
    public static Intent newIntentFromCustomActivity(@NonNull Context context, @NonNull Class<? extends ModerationActivity> cls, @NonNull String channelUrl, @StyleRes int themeResId) {
    ...
    /**
     * It will be called when the {@link ModerationActivity} is being created.
    ...
    protected Fragment createFragment() {
        ...
        return SendbirdUIKit.getFragmentFactory().newModerationFragment(args.getString(StringSet.KEY_CHANNEL_URL, ""), args);
    }
}
