...
/**
 * A module for open channel muted participant list.
 * All composed components are created when the module is created. After than those components can replace.
 *
 * since 3.1.0
 */
public class OpenChannelMutedParticipantListModule extends BaseModule {
    @NonNull
    private final Params params;
    @NonNull
    private HeaderComponent headerComponent;
    @NonNull
    private OpenChannelMutedParticipantListComponent mutedParticipantListComponent;
    @NonNull
     ...
     * since 3.1.0
     */
    public OpenChannelMutedParticipantListModule(@NonNull Context context) {
     ...
     * since 3.1.0
     */
    public OpenChannelMutedParticipantListModule(@NonNull Context context, @NonNull Params params) {
        this.params = params;
        this.headerComponent = new HeaderComponent();
        this.headerComponent.getParams().setUseRightButton(false);
        this.mutedParticipantListComponent = new OpenChannelMutedParticipantListComponent();
    ...
    public View onCreateView(@NonNull Context context, @NonNull LayoutInflater inflater, @Nullable Bundle args) {
        ...
        final View mutedParticipantListLayout = this.mutedParticipantListComponent.onCreateView(listThemeContext, listInflater, innerContainer, args);
        innerContainer.addView(mutedParticipantListLayout);
     ...
     * since 3.1.0
     */
    public <T extends OpenChannelMutedParticipantListComponent> void setMutedParticipantListComponent(@NonNull T component) {
        this.mutedParticipantListComponent = component;
    }
     ...
     */
    @NonNull
    public OpenChannelMutedParticipantListComponent getMutedParticipantListComponent() {
        return mutedParticipantListComponent;
    }
    ...
    public static class Params extends BaseModule.Params {
        ...
        public Params(@NonNull Context context, @StyleRes int themeResId) {
            super(context, themeResId, R.attr.sb_module_open_channel_muted_participant_list);
        }
    }
}
