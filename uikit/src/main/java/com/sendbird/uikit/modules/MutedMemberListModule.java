...
/**
 * A module for muted member list. This module is composed of a header, list, and status.
 ...
 *  <li>List component is {@link MutedMemberListComponent} and you can set custom list component by {@link #setMutedMemberListComponent(MutedMemberListComponent)}
 ...
 * since 3.0.0
 */
public class MutedMemberListModule extends BaseModule {
    @NonNull
    private final Params params;
    @NonNull
    private HeaderComponent headerComponent;
    @NonNull
    private MutedMemberListComponent mutedMemberListComponent;
    @NonNull
     ...
     * since 3.0.0
     */
    public MutedMemberListModule(@NonNull Context context) {
     ...
     * since 3.0.0
     */
    public MutedMemberListModule(@NonNull Context context, @NonNull Params params) {
        this.params = params;
        this.headerComponent = new HeaderComponent();
        this.headerComponent.getParams().setUseRightButton(false);
        this.mutedMemberListComponent = new MutedMemberListComponent();
    ...
    public View onCreateView(@NonNull Context context, @NonNull LayoutInflater inflater, @Nullable Bundle args) {
        ...
        final View mutedMemberListLayout = this.mutedMemberListComponent.onCreateView(listThemeContext, listInflater, innerContainer, args);
        innerContainer.addView(mutedMemberListLayout);
     ...
     * since 3.0.0
     */
    public <T extends MutedMemberListComponent> void setMutedMemberListComponent(@NonNull T component) {
        this.mutedMemberListComponent = component;
    }
     ...
     */
    @NonNull
    public MutedMemberListComponent getMutedMemberListComponent() {
        return mutedMemberListComponent;
    }
    ...
    public static class Params extends BaseModule.Params {
        ...
        public Params(@NonNull Context context, @StyleRes int themeResId) {
            super(context, themeResId, R.attr.sb_module_muted_member_list);
        }
    }
}
