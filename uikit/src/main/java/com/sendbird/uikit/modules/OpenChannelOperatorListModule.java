...
/**
 * A module for open channel operator list.
 * All composed components are created when the module is created. After than those components can replace.
 *
 * since 3.1.0
 */
public class OpenChannelOperatorListModule extends BaseModule {
    @NonNull
    private final Params params;
    @NonNull
    private HeaderComponent headerComponent;
    @NonNull
    private OpenChannelOperatorListComponent operatorListComponent;
    @NonNull
     ...
     * since 3.1.0
     */
    public OpenChannelOperatorListModule(@NonNull Context context) {
     ...
     * since 3.1.0
     */
    public OpenChannelOperatorListModule(@NonNull Context context, @NonNull Params params) {
        this.params = params;
        this.headerComponent = new HeaderComponent();
        this.operatorListComponent = new OpenChannelOperatorListComponent();
     ...
     * since 3.1.0
     */
    public <T extends OpenChannelOperatorListComponent> void setOperatorListComponent(@NonNull T component) {
     ...
     */
    @NonNull
    public OpenChannelOperatorListComponent getOperatorListComponent() {
    ...
    public static class Params extends BaseModule.Params {
        ...
        public Params(@NonNull Context context, @StyleRes int themeResId) {
            super(context, themeResId, R.attr.sb_module_open_channel_operator_list);
        }
    }
}
