 ...
 *  <li>List component is {@link BannedUserListComponent} and you can set custom list component by {@link #setBannedUserListComponent(BannedUserListComponent)}
 ...
 * since 3.0.0
 */
public class BannedUserListModule extends BaseModule {
    @NonNull
    private final Params params;
    @NonNull
    private HeaderComponent headerComponent;
    @NonNull
    private BannedUserListComponent bannedUserListComponent;
    @NonNull
     ...
     * since 3.0.0
     */
    public BannedUserListModule(@NonNull Context context) {
     ...
     * since 3.0.0
     */
    public BannedUserListModule(@NonNull Context context, @NonNull Params params) {
        this.params = params;
        this.headerComponent = new HeaderComponent();
        this.headerComponent.getParams().setUseRightButton(false);
        this.bannedUserListComponent = new BannedUserListComponent();
    ...
    public View onCreateView(@NonNull Context context, @NonNull LayoutInflater inflater, @Nullable Bundle args) {
        ...
        final View userListLayout = this.bannedUserListComponent.onCreateView(listThemeContext, listInflater, innerContainer, args);
     ...
     * since 3.0.0
     */
    public <T extends BannedUserListComponent> void setBannedUserListComponent(@NonNull T component) {
        this.bannedUserListComponent = component;
    }
     ...
     */
    @NonNull
    public BannedUserListComponent getBannedUserListComponent() {
        return bannedUserListComponent;
    }
    ...
    public static class Params extends BaseModule.Params {
        ...
        public Params(@NonNull Context context, @StyleRes int themeResId) {
            super(context, themeResId, R.attr.sb_module_banned_user_list);
        }
    }
}
