...
/**
 * A module for open channel banned user list.
...
public class OpenChannelBannedUserListModule extends BaseModule {
     ...
     * since 3.1.0
     */
    public <T extends OpenChannelBannedUserListComponent> void setBannedUserListComponent(@NonNull T component) {
    ...
    public static class Params extends BaseModule.Params {
        ...
        public Params(@NonNull Context context, @StyleRes int themeResId) {
            super(context, themeResId, R.attr.sb_module_open_channel_banned_user_list);
        }
    }
}
